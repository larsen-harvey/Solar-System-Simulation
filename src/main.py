...
def main(simulation_years=15):
    ...
    system.add_planet(Planet("Mercury", 3.3022e23, 2439.7, 0.387098 * Planet.AU, 0.2056, 0, math.pi/4, math.pi/4, texture="textures/mercury.jpg"))
    system.add_planet(Planet("Venus", 4.8695e24, 6051.8, 0.723336 * Planet.AU, 0.0068, math.pi/2, math.pi/4, 3*math.pi/4, texture="textures/venus.jpg"))
    system.add_planet(Planet("Earth", 5.972e24, 6371, 1.000 * Planet.AU, 0.0167, 0, 0, 0, texture="textures/earth.jpg"))
    system.add_planet(Planet("Mars", 6.4171e23, 3389.5, 1.524 * Planet.AU, 0.0934, 0, 0, 0, texture="textures/mars.jpg"))
    system.add_planet(Planet("Jupiter", 1.8982e27, 69911, 5.2044 * Planet.AU, 0.0489, 0, 0, 0, texture="textures/jupiter.jpg"))
    system.add_planet(Planet("Saturn", 5.6834e26, 58232, 9.5826 * Planet.AU, 0.0565, 0, 0, 0, texture="textures/saturn.jpg"))
    system.add_planet(Planet("Uranus", 8.6810e25, 25362, 19.2184 * Planet.AU, 0.046, 0, 0, 0, texture="textures/uranus.jpg"))
    system.add_planet(Planet("Neptune", 1.02413e26, 24622, 30.110387 * Planet.AU, 0.009, 0, 0, 0, texture="textures/neptune.jpg"))

    # Dwarf planets with textures
    system.add_planet(Planet("Pluto", 1.303e22, 1188.3, 39.482 * Planet.AU, 0.2488, 17.16, 110.299, 113.834, texture="textures/pluto.jpg"))
    system.add_planet(Planet("Haumea", 4.006e21, 816, 43.335 * Planet.AU, 0.191, 28.2, 121.8, 240.6, texture="textures/haumea.jpg"))
    system.add_planet(Planet("Makemake", 3.1e21, 715, 45.79 * Planet.AU, 0.159, 29.0, 79.0, 298.0, texture="textures/makemake.jpg"))
    system.add_planet(Planet("Eris", 1.66e22, 1163, 67.781 * Planet.AU, 0.44, 44.0, 35.9, 151.0, texture="textures/eris.jpg"))
    system.add_planet(Planet("Ceres", 9.393e20, 473, 2.77 * Planet.AU, 0.075, 10.6, 80.3, 73.6, texture="textures/ceres.jpg"))
